"""
db/migrations/env.py — Alembic environment configuration.

Supports both online (direct DB) and offline (SQL script) migration modes.
Autogenerate reads target_metadata from all imported ORM models.
"""
...
# ── Make backend package importable from migration context ────────────────────
